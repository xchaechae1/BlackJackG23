...
public final class DBManager {
    ...
    //automatically start derby network server
    ...
    public static class PlayerStats {
        ...
        public PlayerStats(String username, int balance, int gamesPlayed, int gamesWon, 
                          double winRate, int blackjacks, int bestStreak) {
